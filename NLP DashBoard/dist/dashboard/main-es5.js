...
var PosPageComponent = /** @class */ (function () {
    function PosPageComponent() {
    }
    PosPageComponent.prototype.ngOnInit = function () {
    };
...
var NermoduleComponent = /** @class */ (function () {
    function NermoduleComponent(_formBuilder) {
    ...
    NermoduleComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.stateGroupOptions = this.stateForm.get('stateGroup').valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (value) { return _this._filterGroup(value); }));
    };
    NermoduleComponent.prototype._filterGroup = function (value) {
        if (value) {
    ...
    NermoduleComponent.prototype.add = function (event) {
    ...
    NermoduleComponent.prototype.remove = function (fruit) {
     ...
     * method logical code
     */
    NermoduleComponent.prototype.onCatRemoved = function (cat) {
        var categories = this.categoriesControl.value;
        this.removeFirst(categories, cat);
        this.categoriesControl.setValue(categories); // To trigger change detection
    };
    NermoduleComponent.prototype.removeFirst = function (array, toRemove) {
        var index = array.indexOf(toRemove);
        if (index !== -1) {
            array.splice(index, 1);
        }
    };
    NermoduleComponent.ctorParameters = function () { return [
...
var SementicComponent = /** @class */ (function () {
    function SementicComponent(_formBuilder) {
        this._formBuilder = _formBuilder;
        this.isLinear = true;
        this.foods = [
    ...
    SementicComponent.prototype.ngOnInit = function () {
        this.firstFormGroup = this._formBuilder.group({});
        this.secondFormGroup = this._formBuilder.group({
            secondCtrl: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
        });
    };
    SementicComponent.prototype.drop = function (event) {
    ...
    SementicComponent.prototype.addKeywordFromInput = function (event) {
        if (event.value) {
            this.keywords.add(event.value);
            event.input.value = '';
        }
    };
    SementicComponent.prototype.removeKeyword = function (keyword) {
        this.keywords.delete(keyword);
    };
    SementicComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
...
/* harmony import */ var highcharts_angular__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! highcharts-angular */ "./node_modules/highcharts-angular/fesm5/highcharts-angular.js");
